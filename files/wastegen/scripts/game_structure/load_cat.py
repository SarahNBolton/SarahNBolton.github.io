...
def json_load():
    ...
    for i, cat in enumerate(cat_data):
        try:
            ...
            """Mutations.ear_size_genes = cat["ear_size"]
            cat.mutate.ear_type_genes = cat["ear_type"]
            Mutations.eye_type_genes = cat["eye_type"]
            Mutations.eye_count_genes = cat["eye_type"]
            Mutations.tail_type_genes = cat["tail_type"]
            Mutations.tail_count_genes = cat["tail_count"]
            Mutations.teeth_genes = cat["teeth"]
            Mutations.horns_presence_genes = cat["horns_presence"]
            Mutations.horns_genes = cat["horns"]
            Mutations.wings_presence_genes = cat["wings_presence"]
            print(Mutations.wings_presence_genes[0])
            Mutations.wings_type_genes = cat["wings_type"]
            Mutations.wings_genes = cat["wings"]
            Mutations.extras_presence_genes = cat["extras_presence"]
            Mutations.extras_genes = cat["extras"]"""
            ...
            new_cat.ear_size_genes = cat["ear_size"]
            new_cat.ear_type_genes = cat["ear_type"]
            new_cat.eye_type_genes = cat["eye_type"]
            new_cat.eye_count_genes = cat["eye_count"]
            new_cat.tail_type_genes = cat["tail_type"]
            new_cat.tail_count_genes = cat["tail_count"]
            new_cat.teeth_genes = cat["teeth"]
            new_cat.horns_presence_genes = cat["horns_presence"]
            new_cat.horns_genes = cat["horns"]
            new_cat.wings_presence_genes = cat["wings_presence"]
            print(new_cat.wings_presence_genes[0])
            new_cat.wings_type_genes = cat["wings_type"]
            new_cat.wings_genes = cat["wings"]
            new_cat.extras_presence_genes = cat["extras_presence"]
            new_cat.extras_genes = cat["extras"]
